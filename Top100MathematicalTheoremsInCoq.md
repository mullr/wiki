...
||55 || Product of Segments of Chords || Lemma Product_of_Segments_of_Chords: forall A B C D M O:point,
  samedistance O A O B ->
  samedistance O A O C ->
  samedistance O A O D ->
  collinear A B M ->
  collinear C D M ->
