This file takes all the notations of "Utf8.v" and "Utf8-core.v" and adds a lot of others. See this page_ to find how to use XCompose for an easy access to special characters.
