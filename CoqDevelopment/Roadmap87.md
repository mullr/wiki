...
* ? PR `#145`_ Coqlib cleanup (E. J. Gallego)
...
* ? PR `#86`_: simplify sort_fields (G. Sherer)
...
* ? Inductive-inductive, inductive-recursive, recursive-recursive definitions Experimental branch_, probably not  for 8.6, theoretical issues: guardedness and positivity checking (M. Sozeau)
...
* Ltac implementation refactoring, "Ltac as a plugin" (P.M. Pédrot). Uniform handling of generic arguments.
    ...
    * ?! at the syntax level, when using constr:, ltac:
        ...
        grammar entries in Ltac code, parentheses become mandatory (e.g.: constr:((x, y)) for the pair of terms x y). ipattern_list:([] []). Uniformity vs "non-uglyness".
...
* ML: API cleanup/changes for maps of existential variables and
    ...
    universes. pretyping/evd.ml was moved to engine/evd.ml and a new programming interface engine/sigma.ml is provided to statically ensure the state is used monotonously (using GADTs). namegen, termops, logic_monad, proofview_monad are also in engine.
...
* Typeclasses:
  ...
  * ?! New implementation of typeclasses eauto based on new proof engine, could replace eauto as well: full backtracking, Hint Cut supported, iterative deepening, limited search, ... (M. Sozeau)  `branch <https://github.com/mattam82/coq/commits/bteauto>`__.  To be turned into a PR, compatibility checks to do first.

* ? PR `#72`_ Quote coercions

* PR `#142`_ Patterns in abstractions (D. de Rauglaudre)
...
* PR `#156`_ Coq-level numeral printers, now a CEP: `CEP/Numeral Notation`_ (D. de Rauglaudre)

* PR `#64`_: Add a Print Ltacs vernacular (C. Pit-Claudel)

* ? PR `#113`_: Add the "not a keyword" modifier to notations (J.P. Delaix?)

* ? PR `#114`_: Set Debug Foo vs Set Foo Debug (H. Herbelin)

* ? PR `#162`_: Search Interface Revisions (G. Malecha)
...
* ? PR `#74`_: Range selector (C. Mangin)

* ?! PR `#100`_: fresh accepts more things (P. Courtieu) fresh will succeed more often=incompatibilies. Are these incompatibilites difficult to fix?

* ? PR `#136`_: An adaptation of ssreflect's => to Coq introduction pattern model (H. Herbelin)

* ? PR `#140`_: Iff as a proper connective (H. Herbelin)

* ? PR `#157`_: pat%constr (H. Herbelin)

* ? PR `#146`_: Ssreflect pattern matching facilities (E. Tassi)

* ? PR `#150`_: LtacProf_ (Coq v8.5) (J. Gross, P. Steckler)

* ? PR `#164`_: A few tactics for 8.6 (H. Herbelin)
...
* ?! Improvements to generalized rewriting: faster rewriting with leibniz equality, new strategies, heterogeneous relations... Still WIP (M. Sozeau)
    ...
    `branch <https://github.com/mattam82/coq/commits/genreweqwip>`__
...
* Definition of eta in VectorSpec_.v

* ListSet_ lemmas in Stdlib (S. Hinderer)

* PR `#135`_: Export Nat in NPeano.v (J. Gross) 
...
.. _#145: https://github.com/coq/coq/pull/145
...
.. _branch: https://github.com/mattam82/coq/tree/IR

.. _#72: https://github.com/coq/coq/pull/72

.. _#142: https://github.com/coq/coq/pull/142

.. _#79: https://github.com/coq/coq/pull/78

.. _#85: https://github.com/coq/coq/pull/85

.. _#156: https://github.com/coq/coq/pull/156

.. _#64: https://github.com/coq/coq/pull/64

.. _#113: https://github.com/coq/coq/pull/113

.. _#114: https://github.com/coq/coq/pull/114

.. _#162: https://github.com/coq/coq/pull/162

.. _#74: https://github.com/coq/coq/pull/74

.. _#100: https://github.com/coq/coq/pull/100

.. _#136: https://github.com/coq/coq/pull/136

.. _#140: https://github.com/coq/coq/pull/140

.. _#157: https://github.com/coq/coq/pull/157

.. _#146: https://github.com/coq/coq/pull/146

.. _#150: https://github.com/coq/coq/pull/150

.. _#164: https://github.com/coq/coq/pull/164

.. _#135: https://github.com/coq/coq/pull/135
