...
* Méthode : INRIA va proposer trois types de contrats à PPS, LIX et LRI:
  ...
  #. Contrats non stratégiques pour les collaborations ponctuelles.

  #. Contrats avec personne physique (soit parce que leurs institutions ne veulent pas s'impliquer ou parce qu'ils font du consulting). Ce dernier aspect semble assez flou: qu'est-ce que le "code écrit le week-end et en soirée" pour un chercheur?
...
* Propositions: 
  ...
  * Deux solutions : 
    ...
    #. rendre publique coq-dev et avoir un coq-internal/private/team/gt-coq pour les organisations internes ou les discussions privées (chez BSD : core-developpers, developpers, ...)
...
:::::::::::::::::::::::::::::::::::::::::
  ...
  Ajout de deux constructeurs au type constr:
    ...
    | NativeInt_ of int | NativeArray_ of constr * constr array 
