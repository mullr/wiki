...
More details can also be found `attachment:brochure.pdf`_here`attachment:None`_.

Going from Nantes to Le Croisic takes 1h20 by train. There are also direct train from Paris (3h20).

To go from Le Croisic railway station to Port aux Rocs, you can take Bus 30 (`attachment:ligne_bus.pdf`_schedule`attachment:None`_).
...
* Introduction `attachment:intro.pdf`_slides`attachment:None`_
...
* Coq and User Interfaces (Emilio Jesus Gallego Arias) slides_

* Parametricity in Coq (Abhishek Anand)`attachment:CoqImplWorkshop2017Fixed.pdf`_slides`attachment:None`_

* ELPI (Enrico Tassi)

* The beautifier and notations (Hugo Herbelin) `attachment:beautifier-notations.pdf`_slides`attachment:None`_
...
To register, please fill in the following form_.
...
The `coordination mailing list`_ is the preferred channel to contact the organizers.
...
* By TZ:
  ...
  * Combining focusing with { } and goal selectors (started `here <https://github.com/Zimmi48/coq/tree/testing_brackets_with_goal_selector>`__).
...
* By Abhishek Anand: (the items are below are needed in the implementation of paramcoq-iff_)

  * `Efficiency reducing away mentions of a variable`_

  * `Supporting universes in Template-coq`_

* By Yves

  * port coq-dpdgraph to more recent version of Coq (trunk and pre-8.7)

      `coq-dpdgraph github site`_
...
.. _schedule: https://docs.google.com/spreadsheets/d/1mUtbJHJUKvwyUsp0cNGpTpdErpaxNqjk4TEPjrvIdIg/edit?usp=sharing

.. _slides: https://x80.org/coq2017/

.. _here: https://coq.inria.fr/cocorico/CoqImplementorsWorkshop/CoqIW2017log

.. _form: http://gipco-adns.com/site/5922/coqdev+2017+registration+form

.. _coordination mailing list: https://sympa.inria.fr/sympa/info/coq-implementors-workshop

.. _paramcoq-iff: https://arxiv.org/abs/1705.01163

.. _Efficiency reducing away mentions of a variable: https://sympa.inria.fr/sympa/arc/coq-club/2017-02/msg00059.html

.. _Supporting universes in Template-coq: https://github.com/gmalecha/template-coq/issues/1

.. _coq-dpdgraph github site: https://github.com/Karmaki/coq-dpdgraph
