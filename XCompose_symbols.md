Here is an example of a .XCompose file; you can also take a look in "/usr/share/X11/locale/en\_US.UTF-8/Compose" or "/usr/local/lib/X11/locale/en\_US.UTF-8/Compose" or so, according to your distribution.
