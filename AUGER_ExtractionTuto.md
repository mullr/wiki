Here is some test file for the extractor. Feel free to modify it if something is not badly written, or a new feature has been added, or for any other reason (I prefix my pages with "AUGER\_" to trivially avoid conflicts with already existing pages, not for ownership mark!).
